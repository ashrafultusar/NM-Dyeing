...
function CustomerSavedBillsTab({ customerId }) {
  ...
  const combined = [
    ...billings
      ...
      .map((b) => ({
        ...
        isSaved: savedRecordIds.includes(b._id),
      })),
    ...payments.map((p) => ({
      date: p.date,
      ...
      recordId: p._id,
      modelType: "Payment",
      isSaved: savedRecordIds.includes(p._id),
    })),
  ];
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden print:border-none print:shadow-none">
          ...
          {activeTab === "ledger" ? (
            ...
            <div className="p-5 sm:p-8">
              <CustomerSavedBillsTab customerId={customerId} />
            </div>
          )}
