        ...
        <tbody className="bg-white divide-y divide-gray-100">
          ...
          {rows.map((row, idx) => {
            ...
            return (
              <tr
                key={idx}
                className={`transition-colors ${isSelected ? "bg-indigo-50/50" : "hover:bg-blue-50/30"
          ...
          <div className="p-5 sm:p-8 border-b border-gray-100 bg-white">
            <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
              ...
              <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto print:hidden flex-wrap">
                ...
                <button
                  onClick={() => router.push(`/dashboard/customer/profile/${customerId}/saved-bills`)}
                  className="flex cursor-pointer items-center gap-2 bg-purple-50 text-purple-600 border border-purple-200 rounded-xl px-4 py-2.5 text-xs font-bold hover:bg-purple-100 transition whitespace-nowrap"
                >
                  📄 Saved Invoices
                </button>
                {isCurrentView && (
