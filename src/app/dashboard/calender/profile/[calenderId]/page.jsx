...
export default function CalenderProfileLedger({ params }) {
  ...
  const fetchCurrentLedger = useCallback(async () => {
    try {
      ...
      if (result.success) {
        const { calender: c, billings, payments, openingBalance: ob = 0, initialCharge: ic = 0, initialPayment: ip = 0, initialDate: id = null } = result.data;
        ...
        <div className="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden print:border-none print:shadow-none">
          <div className="p-5 sm:p-8 border-b border-gray-100 bg-white">
            <div className="flex flex-col sm:flex-row justify-between items-start gap-4">
              <div>
                <h1 className="text-xl sm:text-2xl font-black text-gray-900 uppercase">Calender Ledger Statement</h1>
              ...
              <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto print:hidden flex-wrap">
                ...
                <button onClick={() => router.push(`/dashboard/calender/profile/${calenderId}/saved-bills`)} className="flex cursor-pointer items-center gap-2 bg-purple-50 text-purple-600 border border-purple-200 rounded-xl px-4 py-2.5 text-xs font-bold hover:bg-purple-100 transition whitespace-nowrap">
                  📄 Saved Invoices
                </button>
                {isCurrentView && (
